#define NGX_CONFIGURE " --prefix='/usr/local/nginx --sbin-path=/usr/local/nginx/sbin/nginx --conf-path=/usr/local/nginx/conf/nginx.conf --pid-path=/usr/local/nginx/logs/nginx.pid --with-http_ssl_module --with-pcre=/home/koma/ATInstall/src/lib/pcre-8.34 --with-zlib=/home/koma/ATInstall/src/lib/zlib-1.2.8 --with-openssl=/home/koma/ATInstall/src/lib/openssl-1.0.1j' --add-module=/home/koma/ATInstall/extension/extpackage/nginx/nginx-http-concat"
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "/usr/local/nginx --sbin-path=/usr/local/nginx/sbin/nginx --conf-path=/usr/local/nginx/conf/nginx.conf --pid-path=/usr/local/nginx/logs/nginx.pid --with-http_ssl_module --with-pcre=/home/koma/ATInstall/src/lib/pcre-8.34 --with-zlib=/home/koma/ATInstall/src/lib/zlib-1.2.8 --with-openssl=/home/koma/ATInstall/src/lib/openssl-1.0.1j/"
#endif
